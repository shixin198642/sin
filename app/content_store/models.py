...
class StoreConfig(models.Model):
  ...
  vm_args = models.CharField(max_length=1024, default='-Xmx128m -Xms16m')
  ...
  extensions = models.ManyToManyField(File, blank=True, null=True)
  ...
  def __unicode__(self):
    if self.name:
      ...
      return u'%s : %s' % (self.store.name, self.pk)
